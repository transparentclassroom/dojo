...
# https://www.codewars.com/kata/incrementer/train/ruby
#
# Given an input of an array of digits num, return the array with each digit incremented by its
# position in the array. For example, the first digit will be incremented by 1, the second digit by 2
...
#
# Lastly, return [] if your array is empty! Arrays will only contain numbers so don't worry about
# checking that.

def incrementer(arr)
  arr.each_with_index.map { |n, i| (n + (1 + i)) % 10 }
end
